...
from fedml_api.standalone.MyPFL import client
from fedml_api.standalone.MyPFL.client import Client
from fedml_api.standalone.MyPFL.slim_util import model_difference
from fedml_api.standalone.MyPFL.slim_util import hamming_distance

class mypflAPI(object):
